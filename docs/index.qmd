...
This is the documentation for Freylint's NixOS configuration.
A project with the aim to allow my personal software setup to
be uniform, maintainable, and portable.
I chose NixOS for this task for its ability to:

- Be exapndable after being ignored for months
- Facilitate uniform cross platform application and user
configuration, installation, and updates
- Do this while automatically reverting if a problem is detected
- Do this with as painless a setup process as possible
...
This is achieved through Nix, NixOS, Nix Anywhere, Disko, and WSL.
More details will be provided as documentation is improved.
...
I'll start by geting the URL for the REST API I want to call:
```ps1
